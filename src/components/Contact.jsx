  ...
  return (
    <section id='contact' className='my-20 min-h-96 w-screen px-10'>
        <div className='relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'>
            <div className='hidden absolute -left-20 top-0 h-full w-72 overflow-hidden sm:block lg:left-20 lg:w-96'>
...
<div className='flex flex-col items-center text-center '>
 ...
 <p className='special-font mt-10 w-full font-zentry text-5xl leading-[0.9]  md:text-[6rem]' >
    lets b<b>u</b>ild the <br />new era of <br /> Gaming toge <b>ther </b>
 </p>
